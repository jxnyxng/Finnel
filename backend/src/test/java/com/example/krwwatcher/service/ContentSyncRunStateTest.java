...
class ContentSyncRunStateTest {
    ...
    void newsStartupCleanupMarksInterruptedRunAsFailed() {
        ...
        NewsService newsService = new NewsService(null, jdbcTemplate, null, null);
    ...
    void governmentBriefingStartupCleanupMarksInterruptedRunAsFailed() {
        ...
        GovernmentBriefingService governmentBriefingService = new GovernmentBriefingService(null, jdbcTemplate);
