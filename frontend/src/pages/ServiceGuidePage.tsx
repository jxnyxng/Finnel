...
export function ServiceGuidePage() {
    return (
        <section className="service-guide-page relative left-1/2 w-screen -translate-x-1/2">
            {slides.map((slide, index) => (
                <section
                    className="service-guide-slide relative"
                    key={slide.title}
                >
                    <div
                    ...
                    />
                    <div className="service-guide-slide-dim absolute inset-0" />
                    <div className={`service-guide-slide-gradient absolute inset-0 ${index % 2 === 0 ? 'service-guide-slide-gradient-right' : 'service-guide-slide-gradient-left'}`} />

                    <div className="service-guide-slide-content relative z-10 flex items-center justify-center px-6 py-10 md:px-14 md:py-12">
