    ...
    <footer className="mt-6 border-t border-zinc-200 bg-white">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-5 py-6 text-xs text-zinc-500 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0">
          <p className="text-sm font-semibold text-zinc-900">코리아원</p>
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2 md:justify-end">
          <a className="font-semibold text-teal-700 hover:text-teal-800" href="mailto:kim0607mi@gmail.com">
            kim0607mi@gmail.com
          </a>
          <a className="font-semibold text-teal-700 hover:text-teal-800" href="https://github.com/jxnyxng" rel="noreferrer" target="_blank">
            GitHub
          </a>
        </div>
      </div>
